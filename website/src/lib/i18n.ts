...
export const LANG = {
  en: {
    ...
    // Dashboard / My page
    my_title:       "My Superpower",
    my_subtitle:    "Your private dashboard",
    my_status:      "Status",
    my_live:        "Live",
    my_draft:       "Draft",
    ...
    my_no_profile:  "No Superpower yet",
    my_no_profile_sub: "Start building your first business profile.",
    my_start:       "Build my Superpower",
    my_signout:     "Sign out",
  ...
  sa: {
    ...
    // Dashboard / My page
    my_title:       "My Superpower",
    my_subtitle:    "Jou private dashboard",
    my_status:      "Status",
    my_live:        "Lewendig",
    my_draft:       "Konsep",
    ...
    my_no_profile:  "Nog geen Superpower nie",
    my_no_profile_sub: "Begin om jou eerste besigheidsprofiel te bou.",
    my_start:       "Bou my Superpower",
